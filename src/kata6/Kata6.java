...
public class Kata6 {
    ...
    public static void Serializarlo(){
        ...
        Gson gson = new Gson();
        String jsonS = "{'postId':99,'id':99,'name':'NOMBREE','email':'Serializarlo@Title','body':'Serializarlo Body'}";
    ...
    public static void XML() throws JAXBException{
        Comments commentsXML = new Comments(888,888,"Cualquier nombre Name","commentsXML@Title","commentsXML Body");
